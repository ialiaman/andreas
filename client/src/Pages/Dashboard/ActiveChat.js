  ...
  useEffect(() => {
    chatData &&
      axios
        ...
        .then((res) => {
          setagentName(
            res.data.f_name.toUpperCase() + " " + res.data.l_name.toUpperCase()
          );
        })
        .catch((error) => {
                    ...
                    <div className={`${styles.details_body}`}>
                      ...
                      <div className="d-flex flex-column" style={{ gap: 10 }}>
                        ...
                        <div
                          ...
                          style={{ gap: 10 }}
                        >
                          <button className="btn-light-blue py-1"></button>
                    ...
                    <div>
                      <Card show={show} onHide={handleClose}>
                        <form onSubmit={formik.handleSubmit} method="post">
                          <Card.Body>
                            <div class="mb-3">
                              <label htmlFor="c_name" class="form-label">
                                Company Name
                              </label>
                              <select
                                id="c_name"
                          ...
                          <Card.Footer className="d-flex justify-content-between">
                            ...
                            <button
                              type="submit"
                              style={{ border: 0, backgroundColor: "#5BC0DE" }}
  ...
  return (
    <div className="msg mt-4 pt-15 dotted-border-top">
      <div className="d-flex justify-content-between">
        ...
        <div className="span">{props.time}</div>
      </div>
